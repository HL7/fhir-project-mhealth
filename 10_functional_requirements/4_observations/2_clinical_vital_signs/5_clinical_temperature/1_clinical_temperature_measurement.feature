...
Then the <Measurement Site> can be associated with the <Measurement> [[Observation#TemperatureMeasurementSite: bodySite 1..1, bodySite from http://hl7.org/fhir/ValueSet/body-site  ]]
