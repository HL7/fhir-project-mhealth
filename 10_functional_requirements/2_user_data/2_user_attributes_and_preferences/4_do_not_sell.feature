...
Scenario:  User requests their data not be sold or otherwise shared for commercial gain
...
Given A <System> (an App or Infrastructure)
 ...
 Then the <Documentation> describes how a user can request that their data not be sold or otherwise shared for commercial gain.